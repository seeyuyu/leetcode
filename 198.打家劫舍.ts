...
// Your runtime beats 54.19 % of typescript submissions
// Your memory usage beats 9.85 % of typescript submissions (39.5 MB)
// function rob(nums: number[]): number {
//   let len = nums.length
//   let dp = new Array(len)
//   dp[0] = nums[0]
//   dp[1] = Math.max(nums[0], nums[1] ||0)
//   dp[2] = Math.max(dp[1], dp[0] + nums[2] || 0)
//   if(len <3)return dp[len]
//   for(let i = 2; i<len;i++){
